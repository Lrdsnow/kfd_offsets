...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2ed168,
        .kernelcache__gPhysBase = 0xfffffff00783bd00,
        .kernelcache__gPhysSize = 0xfffffff00783bd00 + 8,
        .kernelcache__gVirtBase = 0xfffffff007839ee8,
        .kernelcache__perfmon_devices = 0xfffffff00a326ef0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eadf3c,
        .kernelcache__ptov_table = 0xfffffff0077efbb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a326330,
        .kernelcache__vm_pages = 0xfffffff0077ec8d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077eeb70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a326328,
        .kernelcache__vn_kqfilter = 0xfffffff007efdd64,
    },
};
