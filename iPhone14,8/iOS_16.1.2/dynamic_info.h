...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a384330,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec43b4,
        .kernelcache__ptov_table = 0xfffffff0078039b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a383780,
        .kernelcache__vm_pages = 0xfffffff0078006e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007802978,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a383778,
        .kernelcache__vn_kqfilter = 0xfffffff007f142cc,
    },
};
