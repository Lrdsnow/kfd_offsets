...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a221150,
        .kernelcache__gPhysBase = 0xfffffff0078179d8,
        .kernelcache__gPhysSize = 0xfffffff0078179d8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007815bc0,
        .kernelcache__perfmon_devices = 0xfffffff00a25c300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e6e79c,
        .kernelcache__ptov_table = 0xfffffff0077cb890,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a25b780,
        .kernelcache__vm_pages = 0xfffffff0077c86c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ca850,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a25b778,
        .kernelcache__vn_kqfilter = 0xfffffff007ec0d00,
    },
};
