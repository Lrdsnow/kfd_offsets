...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a345150,
        .kernelcache__gPhysBase = 0xfffffff007867910,
        .kernelcache__gPhysSize = 0xfffffff007867910 + 8,
        .kernelcache__gVirtBase = 0xfffffff007865af8,
        .kernelcache__perfmon_devices = 0xfffffff00a3802f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecbfe4,
        .kernelcache__ptov_table = 0xfffffff00781b8a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a37f780,
        .kernelcache__vm_pages = 0xfffffff0078186d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781a858,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a37f778,
        .kernelcache__vn_kqfilter = 0xfffffff007f1e210,
    },
};
