...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2f1150,
        .kernelcache__gPhysBase = 0xfffffff0078577d0,
        .kernelcache__gPhysSize = 0xfffffff0078577d0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078559b8,
        .kernelcache__perfmon_devices = 0xfffffff00a32aeb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eb5b60,
        .kernelcache__ptov_table = 0xfffffff00780baa0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a32a330,
        .kernelcache__vm_pages = 0xfffffff0078088c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00780aa50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a32a328,
        .kernelcache__vn_kqfilter = 0xfffffff007f07c74,
    },
};
