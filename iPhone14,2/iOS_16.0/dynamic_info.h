...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Aug 16 20:51:28 PDT 2022; root:xnu-8792.2.11.0.1~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a30d168,
        .kernelcache__gPhysBase = 0xfffffff00783fd00,
        .kernelcache__gPhysSize = 0xfffffff00783fd00 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783dee8,
        .kernelcache__perfmon_devices = 0xfffffff00a346ef0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eb5f3c,
        .kernelcache__ptov_table = 0xfffffff0077f3bb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a346330,
        .kernelcache__vm_pages = 0xfffffff0077f08d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2b70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a346328,
        .kernelcache__vn_kqfilter = 0xfffffff007f05d64,
    },
};
