...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffe0007a982a8,
        .kernelcache__gPhysSize = 0xfffffe0007a982a8 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a96460,
        .kernelcache__perfmon_devices = 0xfffffe000abc5550,
        .kernelcache__perfmon_dev_open = 0xfffffe00080f8dfc,
        .kernelcache__ptov_table = 0xfffffe00079e39c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000abc4910,
        .kernelcache__vm_pages = 0xfffffe00079e0108,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079e2968,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000abc4908,
        .kernelcache__vn_kqfilter = 0xfffffe0008147958
    },
};
