...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysSize = 0xfffffff00784bd50 + 8,
        ...
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a34b780,
        .kernelcache__vm_pages = 0xfffffff0077fc6d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fe9d8,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a34b778,
