...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1cd150,
        .kernelcache__gPhysBase = 0xfffffff007803898,
        .kernelcache__gPhysSize = 0xfffffff007803898 + 8,
        .kernelcache__gVirtBase = 0xfffffff007801a80,
        .kernelcache__perfmon_devices = 0xfffffff00a206ec0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e5c368,
        .kernelcache__ptov_table = 0xfffffff0077b7a88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a206330,
        .kernelcache__vm_pages = 0xfffffff0077b48c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077b6a48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a206328,
        .kernelcache__vn_kqfilter = 0xfffffff007eae7b4,
    },
};
