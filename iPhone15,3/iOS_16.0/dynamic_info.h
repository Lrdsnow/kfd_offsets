...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Aug 16 20:51:14 PDT 2022; root:xnu-8792.2.11.0.1~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2b5168,
        .kernelcache__gPhysBase = 0xfffffff007837c10,
        .kernelcache__gPhysSize = 0xfffffff007837c10 + 8,
        .kernelcache__gVirtBase = 0xfffffff007835df8,
        .kernelcache__perfmon_devices = 0xfffffff00a2eeed0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea5e10,
        .kernelcache__ptov_table = 0xfffffff0077ebc10,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2ee330,
        .kernelcache__vm_pages = 0xfffffff0077e88d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077eabd0,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2ee328,
        .kernelcache__vn_kqfilter = 0xfffffff007ef5c38,
    },
};
