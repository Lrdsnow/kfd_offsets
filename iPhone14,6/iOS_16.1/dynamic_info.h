...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c5168,
        .kernelcache__gPhysBase = 0xfffffff00785fe40,
        .kernelcache__gPhysSize = 0xfffffff00785fe40 + 8,
        .kernelcache__gVirtBase = 0xfffffff00785e028,
        .kernelcache__perfmon_devices = 0xfffffff00a400330,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee43b4,
        .kernelcache__ptov_table = 0xfffffff0078139b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3ff780,
        .kernelcache__vm_pages = 0xfffffff0078106e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007812978,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3ff778,
        .kernelcache__vn_kqfilter = 0xfffffff007f342cc,
    },
};
