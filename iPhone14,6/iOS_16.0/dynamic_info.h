...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a369168,
        .kernelcache__gPhysBase = 0xfffffff00784bd00,
        .kernelcache__gPhysSize = 0xfffffff00784bd00 + 8,
        .kernelcache__gVirtBase = 0xfffffff007849ee8,
        .kernelcache__perfmon_devices = 0xfffffff00a3a2ef0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ec9f3c,
        .kernelcache__ptov_table = 0xfffffff0077ffbb0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3a2330,
        .kernelcache__vm_pages = 0xfffffff0077fc8d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077feb70,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3a2328,
        .kernelcache__vn_kqfilter = 0xfffffff007f19d64,
    },
};
