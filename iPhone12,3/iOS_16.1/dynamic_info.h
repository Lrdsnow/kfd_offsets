...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a351150,
        .kernelcache__gPhysBase = 0xfffffff00786b910,
        .kernelcache__gPhysSize = 0xfffffff00786b910 + 8,
        .kernelcache__gVirtBase = 0xfffffff007869af8,
        .kernelcache__perfmon_devices = 0xfffffff00a38c2f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecffe4,
        .kernelcache__ptov_table = 0xfffffff00781f8a8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a38b780,
        .kernelcache__vm_pages = 0xfffffff00781c6d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00781e858,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a38b778,
        .kernelcache__vn_kqfilter = 0xfffffff007f22210,
    },
};
