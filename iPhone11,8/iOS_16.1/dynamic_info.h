...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a0e1150,
        .kernelcache__gPhysBase = 0xfffffff0077f79d8,
        .kernelcache__gPhysSize = 0xfffffff0077f79d8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077f5bc0,
        .kernelcache__perfmon_devices = 0xfffffff00a11c300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e3279c,
        .kernelcache__ptov_table = 0xfffffff0077ab890,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a11b780,
        .kernelcache__vm_pages = 0xfffffff0077a86c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077aa850,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a11b778,
        .kernelcache__vn_kqfilter = 0xfffffff007e84d00,
    },
};
