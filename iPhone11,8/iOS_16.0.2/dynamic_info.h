...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Aug 16 20:50:53 PDT 2022; root:xnu-8792.2.11.0.1~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a08d150,
        .kernelcache__gPhysBase = 0xfffffff0077e7898,
        .kernelcache__gPhysSize = 0xfffffff0077e7898 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e5a80,
        .kernelcache__perfmon_devices = 0xfffffff00a0c6ec0,
        .kernelcache__perfmon_dev_open = 0xfffffff007e20368,
        .kernelcache__ptov_table = 0xfffffff00779ba88,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a0c6330,
        .kernelcache__vm_pages = 0xfffffff0077988c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00779aa48,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a0c6328,
        .kernelcache__vn_kqfilter = 0xfffffff007e727b4,
    },
};
