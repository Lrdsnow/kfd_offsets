...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Aug 16 20:50:57 PDT 2022; root:xnu-8792.2.11.0.1~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a2ad150,
        .kernelcache__gPhysBase = 0xfffffff0078477d0,
        .kernelcache__gPhysSize = 0xfffffff0078477d0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078459b8,
        .kernelcache__perfmon_devices = 0xfffffff00a2e6eb0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea1b60,
        .kernelcache__ptov_table = 0xfffffff0077fbaa0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2e6330,
        .kernelcache__vm_pages = 0xfffffff0077f88c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077faa50,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2e6328,
        .kernelcache__vn_kqfilter = 0xfffffff007ef3c74,
    },
};
