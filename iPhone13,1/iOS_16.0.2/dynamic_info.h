...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.0.0: Tue Aug 16 20:52:01 PDT 2022; root:xnu-8792.2.11.0.1~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a349168,
        .kernelcache__gPhysBase = 0xfffffff007833d00,
        .kernelcache__gPhysSize = 0xfffffff007833d00 + 8,
        .kernelcache__gVirtBase = 0xfffffff007831ee8,
        .kernelcache__perfmon_devices = 0xfffffff00a382ef0,
        .kernelcache__perfmon_dev_open = 0xfffffff007eb1050,
        .kernelcache__ptov_table = 0xfffffff0077e7bb8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a382330,
        .kernelcache__vm_pages = 0xfffffff0077e48d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077e6b68,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a382328,
        .kernelcache__vn_kqfilter = 0xfffffff007f033e4,
    },
};
